...
public class SendMessage {
    public static HashMap<String, String> getMessageStatus(String phonenum) throws HttpException, IOException {
        ...
        //短信模板
        NameValuePair[] data = {
                new NameValuePair("Uid", "trylaoyu"),//sms短信通 注册的用户名
                new NameValuePair("Key", "d41d8cd98f00b204e980"), //密匙
                new NameValuePair("smsMob", phonenum),//要发送的手机号
