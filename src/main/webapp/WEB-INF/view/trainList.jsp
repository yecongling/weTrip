...
<div class="container">
                        ...
                        <c:when test="${sessionScope.user != null}">
                            <li class="dropdown" id="dropdown02">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                   aria-haspopup="true"
                                   aria-expanded="false">欢迎您,${sessionScope.user.userName} <span class="caret"></span></a>
    ...
    <div class="titleAddress">
        <h2>
            ...
            <span style="font-size: 12px;color: black;padding-left: 20px;">共<span
                    style="color: red;font-size: 20px;">${count}</span>个车次</span>
        </h2>
    </div>
        ...
        <div style="clear:both;display: block;height: 160px;border-bottom: 1px solid grey;">
            <div class="col-lg-7" style="float: left;">
                <div class="col-lg-3"><span
                        style="line-height: 160px;font-size: 14px;"><strong>${trainInfo.trainName}</strong></span></div>
                <div class="col-lg-9"><span
                        style="line-height: 160px;font-size: 20px;"><strong>${trainInfo.fromTime}</strong></span>
                ...
                <div style="margin-top: 30px; margin-left: 20px;">
                    <table class="table  table-hover table-bg">
                        ...
                        <tr class="text-c" style="border:hidden;">
                            <td style="font-size: 16px;">${trainInfo.ticketTypea}<span
                                    style="color: red;font-size: 16px;">&nbsp;&nbsp;&nbsp;¥${trainInfo.ticketaPrice}</span>
                            </td>
                            <td>余${trainInfo.ticketaNumber}张</td>
                            <td style="font-size: 16px;"><a href="<%=request.getContextPath()%>/alipay/goAlipay/?orderNum=20192019"
                                    style=" display: block;height: 24px;width: 60px;background: #ff9933;color:#fff;font-weight: bold;text-decoration: none;border-radius:5px;line-height: 24px;"><span style="margin-left: 15px;">预定</span></a>
                            </td>
                        </tr>
                        <tr class="text-c" style="border:hidden;">
                            <td style="font-size: 16px;">${trainInfo.ticketTypeb}<span
                                    style="color: red;font-size: 16px;">&nbsp;&nbsp;&nbsp;¥${trainInfo.ticketbPrice}</span>
                            </td>
                            <td>余${trainInfo.ticketbNumber}张</td>
                            <td style="font-size: 16px;"><a href="<%=request.getContextPath()%>/alipay/goAlipay/?orderNum=20181122"
                                    style=" display: block;height: 24px;width: 60px;background: #ff9933;color:#fff;font-weight: bold;text-decoration: none;border-radius:5px;line-height: 24px;"><span style="margin-left: 15px;">预定</span></a></td>
                        </tr>
                        <tr class="text-c" style="border:hidden;">
                            <td style="font-size: 16px;">${trainInfo.ticketTypec}<span
                                    style="font-size: 16px;color: red;">&nbsp;&nbsp;&nbsp;¥${trainInfo.ticketcPrice}</span>
                            </td>
                            <td>余${trainInfo.ticketcNumber}张</td>
                            <td style="font-size: 16px;"><a href=""
                                    style=" display: block;height: 24px;width: 60px;background: #ff9933;color:#fff;font-weight: bold;text-decoration: none;border-radius:5px;line-height: 24px;"><span style="margin-left: 15px;">预定</span></a></td>
                        </tr>
                        </tbody>
                    </table>
