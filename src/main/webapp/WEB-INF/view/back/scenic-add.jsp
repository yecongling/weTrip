...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<%=request.getContextPath()%>/scenic-put">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>景点名字：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="输入景点的名字" name="scenicName" style="border-radius: 5px">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">景点地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="输入景点的地址" name="address" style="border-radius: 5px">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>所属类别：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<span class="select-box" style="border-radius: 5px">
				<select name="scenicType" class="select">
					<c:forEach items="${requestScope.scenicTypes}" var="scenicTypes">
						<option value="${scenicTypes.scenicTypeId}">${scenicTypes.scenicTypeName}</option>
					</c:forEach>
				</select>
				</span>
			</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">票价：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="输入景区票价" name="price" style="border-radius: 5px">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="描述控制在30个字符之内,包含空格" name="description" style="border-radius: 5px">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">景点主页面图片上传：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-list-container" style="border-radius: 5px">
					<div class="queueList">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button class="btn btn-secondary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并审核</button>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/static/lib/webuploader/0.1.5/webuploader.js"></script>
...
$(function(){
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: '<%=request.getContextPath()%>/lib/webuploader/0.1.5/Uploader.swf',
	
		// 文件接收服务端。
		server: '<%=request.getContextPath()%>/picture-upload',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('<%=request.getContextPath()%>/lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
