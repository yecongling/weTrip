...
<div class="container">
    ...
    <form class="form-horizontal" action="<%=request.getContextPath() %>/createOrder" method="post">
            <div class="row" style="padding: 20px 0">
                <h3>生成订单</h3>
            </div>
            <div class="row form-group">
                <div class="col-lg-5 col-md-6">
                    <input class="form-control" type="hidden" id="scenicId" name="scenicId" value="${scenic.scenicId}">
                </div>
            </div>
            <div class="row form-group">
            ...
            <div class="row form-group">
                <label class="control-label col-lg-1">产品价格</label>
                <div class="col-lg-5 col-md-6">
                    <input class="form-control" type="text" readonly="readonly" value="${scenic.price}">
                </div>
            </div>
            <div class="row form-group">
                <label class="control-label col-lg-1">购买数量</label>
                <div class="col-lg-5 col-md-6">
                    <input class="form-control" type="text" readonly="readonly" id="buyCounts" name="buyCounts"
                           value="${buyCounts} ">
                </div>
            </div>
            <br>
            <input style="margin-left: 250px" type="submit" class="btn btn-primary" value="提交订单">
    </form>
</div>
