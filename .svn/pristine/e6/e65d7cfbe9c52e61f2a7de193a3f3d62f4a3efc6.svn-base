...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l">
        <a class="btn btn-primary radius" href="<%=request.getContextPath()%>/scenic-add"><i class="Hui-iconfont">&#xe600;</i> 新景点入驻</a></span>
    </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <c:forEach items="${scenicUtilList}" var="scenic">
                <tr class="text-c">
                    ...
                    <td><img width="100px" height="60.99px" src="<%=request.getContextPath()%>/static/img/${scenic.picturePath}"></td>
                    <td class="td-status">
                        <c:choose>
...
<script type="text/javascript">
    ...
    /*图片-下架*/
    function picture_stop(obj, scenicId) {
        layer.confirm('确认要下架吗？', function () {
            $(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="picture_start(this,scenicId)" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe603;</i></a>');
    ...
    /*图片-发布*/
    function picture_start(obj, scenicId) {
        layer.confirm('确认要发布吗？', function () {
            $(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="picture_stop(this,scenicId)" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>');
