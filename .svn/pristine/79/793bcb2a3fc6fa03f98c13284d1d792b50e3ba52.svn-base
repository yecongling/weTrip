                    ...
                    <td>
                        <c:choose>
                            <c:when test="${user.enable == true}">
                                <a class="btn btn-danger btn-xs" style="height: 20px; line-height: 17px;"
                                   href="<%=request.getContextPath()%>/updateUserStates?userId=${user.userId}">禁用
                                </a></c:when>
                            <c:otherwise>
                                <a class="btn btn-success btn-xs" style="height: 20px; line-height: 17px;"
                                   href="<%=request.getContextPath()%>/updateUserStates?userId=${user.userId}">启用
                                </a>
                            </c:otherwise>
                        </c:choose>
                    </td>
